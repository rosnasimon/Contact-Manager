...
import com.htc.main.ContactManager;
...
public class ContactManagerTest {
    ...
    public void shouldThrowRuntimeExceptionWhenFirstNameIsNull() {
        Assertions.assertThrows(RuntimeException.class, () -> {
            contactManager.addContact(null, "Doe", "1234567890");
        });
    }
    ...
    @Test
    @DisplayName("Phone Number should end with 0")
    ...
    class ParameterizedTests {
        ...
        @ParameterizedTest
        @ValueSource(strings = {"1234567890", "1234567980", "1234568970"})
        ...
        @ParameterizedTest
        @CsvSource({"1234567890", "1234567980", "1234568970"})
    ...
    private static List<String> phoneNumberList() {
        return Arrays.asList("1234567890", "1234567980", "1234568970");
    }
